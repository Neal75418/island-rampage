...
impl Plugin for CameraPlugin {
    fn build(&self, app: &mut App) {
        app.init_resource::<crate::core::CameraSettings>()
            ...
            .add_systems(
                ...
                (
                    ...
                    dynamic_fov_system.after(camera_input),
                    recoil_and_shake_update_system,
                    cinematic_camera_system,
                    cinematic_letterbox_system.after(cinematic_camera_system),
                    cinematic_hud_toggle_system.after(cinematic_letterbox_system),
                )
