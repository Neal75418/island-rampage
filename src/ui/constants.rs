...
/// 股票上漲色（綠色）
pub const STOCK_UP_COLOR: Color = Color::srgb(0.25, 0.85, 0.35);
/// 股票下跌色（紅色）
pub const STOCK_DOWN_COLOR: Color = Color::srgb(0.85, 0.2, 0.15);
/// 股票持平色（灰色）
pub const STOCK_NEUTRAL_COLOR: Color = Color::srgba(0.6, 0.6, 0.65, 0.9);
/// 市場關閉提示色（橙色）
pub const MARKET_CLOSED_COLOR: Color = Color::srgba(0.8, 0.5, 0.2, 0.9);
...
/// 小地圖內容區域尺寸
pub const MINIMAP_CONTENT_SIZE: f32 = 300.0;
/// 小地圖邊框尺寸（含邊距）
pub const MINIMAP_FRAME_SIZE: f32 = 308.0;
/// 小地圖外層容器尺寸
pub const MINIMAP_OUTER_SIZE: f32 = 316.0;

/// 全屏地圖寬度
pub const FULLMAP_WIDTH: f32 = 1200.0;
/// 全屏地圖高度
pub const FULLMAP_HEIGHT: f32 = 800.0;
