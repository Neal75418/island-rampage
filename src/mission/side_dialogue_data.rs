...
use super::dialogue::{
    DialogueChoice, DialogueCondition, DialogueConsequence, DialogueNode, DialogueSpeaker,
    DialogueTree, SpeakerEmotion,
};
...
pub(super) fn create_dog_uncle_start() -> DialogueTree {
    ...
    tree.add_node(
        DialogueNode::new(
            1,
            npc,
            "我老了，打不過他們。你能不能幫我教訓教訓他們？拜託了。",
        )
        .with_emotion(SpeakerEmotion::Sad)
        .with_choice(
            DialogueChoice::simple("虐待動物的人最可惡！交給我", 2).with_consequence(
        ...
        .with_choice(DialogueChoice::simple("我來處理", 3).with_consequence(
            DialogueConsequence::ChangeRelationship {
                npc_id: NPC_STRAY_DOG_UNCLE,
                delta: 5,
            },
        ...
        .with_choice(
            DialogueChoice::simple("你為什麼不自己去報警？", 4).with_consequence(
                DialogueConsequence::ChangeRelationship {
                    npc_id: NPC_STRAY_DOG_UNCLE,
                    delta: -5,
                },
    ...
    tree.add_node(
        DialogueNode::new(
            4,
            npc,
            "報警？上次報警警察說「只是流浪狗」就不理了。牠們也是生命啊……",
        )
        .with_emotion(SpeakerEmotion::Sad)
        .with_choice(
            DialogueChoice::simple("你說得對，我去教訓他們", 2).with_consequence(
                DialogueConsequence::ChangeRelationship {
                    npc_id: NPC_STRAY_DOG_UNCLE,
                    delta: 10,
                },
        ...
        .with_choice(
            DialogueChoice::simple("抱歉，我幫不了", 5).with_consequence(
                DialogueConsequence::ChangeRelationship {
                    npc_id: NPC_STRAY_DOG_UNCLE,
                    delta: -10,
                },
...
pub(super) fn create_dog_uncle_end() -> DialogueTree {
    ...
    tree.add_node(
        DialogueNode::new(1, npc, "我沒什麼錢，但這個是我的一點心意。謝謝你，年輕人。")
            .with_emotion(SpeakerEmotion::Happy)
            .with_choice(DialogueChoice::simple("照顧好狗狗們", 2).with_consequence(
                DialogueConsequence::ChangeRelationship {
                    npc_id: NPC_STRAY_DOG_UNCLE,
                    delta: 10,
                },
            ))
            .with_choice(DialogueChoice::simple("不用客氣", 3))
            .with_choice(
    ...
    tree.add_node(
        DialogueNode::new(2, npc, "放心，我會的。牠們就像我的家人一樣。")
            .with_emotion(SpeakerEmotion::Happy)
            .with_choice(DialogueChoice::end("再見，大叔").with_consequence(
...
pub(super) fn create_racer_start() -> DialogueTree {
    ...
    tree.add_node(
        DialogueNode::new(
            1,
            npc,
            "我是海岸線車隊的頭。聽說你車開得不錯？來跟我比一場怎樣？有膽就來！",
        )
        .with_emotion(SpeakerEmotion::Smirk)
        .with_choice(
            DialogueChoice::simple("來就來，誰怕誰！", 2).with_consequence(
                DialogueConsequence::ChangeRelationship {
        ...
        .with_choice(
            DialogueChoice::simple("我沒興趣跟你比", 4).with_consequence(
                DialogueConsequence::ChangeRelationship {
                    npc_id: NPC_STREET_RACER,
                    delta: -10,
                },
    ...
    tree.add_node(
        DialogueNode::new(
            3,
            npc,
            "喔？有膽量！好，賭注翻倍！你贏了我給你雙倍獎金。你輸了……嘿嘿。",
        )
        .with_emotion(SpeakerEmotion::Smirk)
    ...
    tree.add_node(
        DialogueNode::new(4, npc, "切！膽小鬼。不敢就別在島上混。")
            .with_emotion(SpeakerEmotion::Angry)
            .with_choice(
                DialogueChoice::simple("你說誰膽小！我來！", 2).with_consequence(
                    DialogueConsequence::ChangeRelationship {
                        npc_id: NPC_STREET_RACER,
                        delta: 15,
                    },
...
pub(super) fn create_racer_end() -> DialogueTree {
    ...
    tree.add_node(
        DialogueNode::new(1, npc, "行，你夠厲害。這是賭金，一毛不少。")
            ...
            .with_choice(DialogueChoice::simple("承讓了", 2).with_consequence(
                DialogueConsequence::ChangeRelationship {
                    npc_id: NPC_STREET_RACER,
                    delta: 5,
                },
            ...
            .with_choice(
                DialogueChoice::simple("下次再來一場！", 3).with_consequence(
                    DialogueConsequence::ChangeRelationship {
                        npc_id: NPC_STREET_RACER,
                        delta: 10,
                    },
    ...
    tree.add_node(
        DialogueNode::new(3, npc, "哈！你有種！好，下次我用我的改裝車來，看誰快！")
            .with_emotion(SpeakerEmotion::Smirk)
            .with_choice(DialogueChoice::end("隨時奉陪").with_consequence(
                DialogueConsequence::SetStoryFlag {
    ...
    tree.add_node(
        DialogueNode::new(
            4,
            npc,
            "加入你？……你是認真的？嗯……你開車確實比我強。好！以後你就是老大！",
        )
        .with_emotion(SpeakerEmotion::Surprised)
...
pub(super) fn create_blogger_start() -> DialogueTree {
    ...
    tree.add_node(
        DialogueNode::new(2, npc, "我需要有人去現場拍照蒐證。你願意幫我揭發真相嗎！？")
            .with_emotion(SpeakerEmotion::Serious)
            .with_choice(
                DialogueChoice::simple("聽起來很有趣，我去查查", 3).with_consequence(
                    DialogueConsequence::ChangeRelationship {
            ...
            .with_choice(
                DialogueChoice::simple("你是不是想太多了？", 4).with_consequence(
                    DialogueConsequence::ChangeRelationship {
                        npc_id: NPC_CONSPIRACY_BLOGGER,
                        delta: -10,
                    },
            ...
            .with_choice(DialogueChoice::simple("有報酬嗎？", 5)),
    );
    ...
    tree.add_node(
        DialogueNode::new(
            3,
            npc,
            "太好了！你是第一個相信我的人！去這三個地方看看，有什麼發現回來告訴我！",
        )
        .with_emotion(SpeakerEmotion::Happy)
        .with_choice(DialogueChoice::end("我這就去")),
    );
    ...
    tree.add_node(
        DialogueNode::new(
            4,
            npc,
            "想太多！？你看看我的鋁箔帽！這是防止他們讀取腦波的！你去看了就知道我說的是真的！",
        )
        .with_emotion(SpeakerEmotion::Angry)
        .with_choice(
            DialogueChoice::simple("好吧，我去看看總行了吧", 3).with_consequence(
                DialogueConsequence::ChangeRelationship {
                    npc_id: NPC_CONSPIRACY_BLOGGER,
                    delta: 5,
                },
        ...
        .with_choice(DialogueChoice::simple("你需要看醫生", 6).with_consequence(
            DialogueConsequence::ChangeRelationship {
                npc_id: NPC_CONSPIRACY_BLOGGER,
                delta: -15,
            },
    ...
    tree.add_node(
        DialogueNode::new(
            5,
            npc,
            "報酬？真相就是最好的報酬！……好啦，我部落格有贊助商，事成之後分你一點。",
        )
        .with_emotion(SpeakerEmotion::Thinking)
        .with_choice(DialogueChoice::simple("好，成交", 3).with_consequence(
            DialogueConsequence::ChangeRelationship {
                npc_id: NPC_CONSPIRACY_BLOGGER,
                delta: 5,
            },
...
pub(super) fn create_blogger_end() -> DialogueTree {
    ...
    tree.add_node(
        DialogueNode::new(
            1,
            npc,
            "廢棄工廠裡有奇怪的設備、電塔發出不明訊號、港口的貨櫃都是空的卻有警衛！這絕對不正常！",
        )
        .with_emotion(SpeakerEmotion::Serious)
        .with_choice(
        ...
        .with_choice(
            DialogueChoice::simple("可能只是巧合吧", 3).with_consequence(
                DialogueConsequence::ChangeRelationship {
                    npc_id: NPC_CONSPIRACY_BLOGGER,
                    delta: -5,
                },
    ...
    tree.add_node(
        DialogueNode::new(
            2,
            npc,
            "對吧對吧！我要把這些全部寫到部落格上！謝謝你的幫忙！這是你的報酬！",
        )
        .with_emotion(SpeakerEmotion::Happy)
    ...
    tree.add_node(
        DialogueNode::new(
            4,
            npc,
            "真的嗎！？太好了！我一個人調查好孤獨……有你在我更有信心了！我們下次去挖更深的真相！",
        )
        .with_emotion(SpeakerEmotion::Happy)
